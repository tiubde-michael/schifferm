export const posts = [
  {
    slug: "arztdokumentation-mit-lokaler-llm",
    ...
    body: `
      <p>Lokale LLMs können medizinische Dokumentationen deutlich beschleunigen, ohne sensible Daten nach außen zu geben.</p>
      <p>Wir kombinieren On-Prem Modelle mit klaren Guardrails, Vorlagen und einem Prüfprozess, damit Qualität und Compliance stimmen.</p>
      <h2>Was sich verbessert</h2>
      <ul>
        <li>Strukturierte Befunde in Minuten statt Stunden</li>
        <li>Nachvollziehbare Quellen und Versionen</li>
        <li>DSGVO-konforme Verarbeitung im eigenen Netzwerk</li>
      </ul>
    `,
  },
  {
    ...
    body: `
      <p>Fragebögen lassen sich heute automatisiert auswerten, ohne dass manuelle Schritte die Wartezeit verlängern.</p>
      <p>Wir nutzen strukturierte Extraktionen, definierte Scores und eine klare Audit-Logik für ärztliche Rückfragen.</p>
      <h2>Ergebnis</h2>
      <ul>
        <li>Klare Priorisierung relevanter Fälle</li>
        <li>Einheitliche Darstellung über Standorte hinweg</li>
        <li>Transparente Kriterien für medizinische Teams</li>
      </ul>
    `,
  },
  {
    ...
    bodyMarkdown: `
# Roboter werden bessere Chirurgen – eine provokante These mit realistischem Zeithorizont
