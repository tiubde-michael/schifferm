...
const pmBannerImage = "/assets/images/PM00PM1.JPG";
const systemanalyseImage = "/assets/images/PM00SA1.GIF";
const lieferantenImage = "/assets/images/Lieferanten-Kunden.JPG";
const weltVerlagerungImage = "/assets/images/Welt-Verlagerung.JPG";
const crisis1Image = "/assets/images/j0200271.GIF";
const crisis2Image = "/assets/images/j0379443.GIF";
const crisis3Image = "/assets/images/bd06670_.GIF";
const crisis4Image = "/assets/images/j0432031.GIF";
const crisis5Image = "/assets/images/j0422532.jpg";
const tiLegacyLogoImage = "/assets/images/The_Implementers.jpg";

function LeistungenProjektmanagement({ sections }) {
  const safeSections = {
    pmTitle: sections?.pmTitle || "",
    pmHtml: sections?.pmHtml || "",
    saTitle: sections?.saTitle || "",
    saHtml: sections?.saHtml || "",
    leTitle: sections?.leTitle || "",
    leHtml: sections?.leHtml || "",
    pvTitle: sections?.pvTitle || "",
    pvHtml: sections?.pvHtml || "",
      ...
      <section id="projektmanagement" className="mx-auto max-w-6xl px-4 py-10 scroll-mt-24">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            {safeSections.pmTitle ? <p className="mt-2 text-sm font-semibold text-slate-900">{safeSections.pmTitle}</p> : null}
            <div className={"mt-4 " + richTextClass} dangerouslySetInnerHTML={{ __html: safeSections.pmHtml }} />
            <button
              type="button"
              onClick={scrollToTop}
      ...
      <section id="systemanalyse" className="mx-auto max-w-6xl px-4 py-10 scroll-mt-24">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            {safeSections.saTitle ? <p className="mt-2 text-sm font-semibold text-slate-900">{safeSections.saTitle}</p> : null}
            <div className={"mt-4 " + richTextClass} dangerouslySetInnerHTML={{ __html: safeSections.saHtml }} />
            <button
              type="button"
              onClick={scrollToTop}
              className="mt-6 inline-block text-sm font-semibold text-implementers-blue hover:underline"
      ...
      <section id="lean" className="mx-auto max-w-6xl px-4 py-10 scroll-mt-24">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            {safeSections.leTitle ? <p className="mt-2 text-sm font-semibold text-slate-900">{safeSections.leTitle}</p> : null}
            <div className={"mt-4 " + richTextClass} dangerouslySetInnerHTML={{ __html: safeSections.leHtml }} />
            <button
              type="button"
              onClick={scrollToTop}
              className="mt-6 inline-block text-sm font-semibold text-implementers-blue hover:underline"
      ...
      <section id="verlagerungen" className="mx-auto max-w-6xl px-4 py-10 scroll-mt-24">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            {safeSections.pvTitle ? <p className="mt-2 text-sm font-semibold text-slate-900">{safeSections.pvTitle}</p> : null}
            <div className={"mt-4 " + richTextClass} dangerouslySetInnerHTML={{ __html: safeSections.pvHtml }} />
            <button
              type="button"
              onClick={scrollToTop}
              className="mt-6 inline-block text-sm font-semibold text-implementers-blue hover:underline"
      ...
      <section id="krisenmanagement" className="mx-auto max-w-6xl px-4 py-10 scroll-mt-24">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
          <div>
            ...
            {safeSections.kmTitle ? <p className="mt-2 text-sm font-semibold text-slate-900">{safeSections.kmTitle}</p> : null}
              ...
              <table className="w-full min-w-[680px] border-collapse">
                <tbody>
                  ...
                  <tr className="border-b border-slate-200">
                    ...
                    <td className="border border-slate-200 p-4 text-slate-700 leading-relaxed">
                      <Link href="/impressum" className="font-semibold text-implementers-blue hover:underline">
