...
function Prozessoptimierung({ legacyHtml }) {
  const legacyContent = legacyHtml
    ? sanitizeLegacyProcessHtml(extractLegacyBody(legacyHtml))
    : "";
        ...
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Link
                href="/leistungen/prozessoptimierung/kaizen"
              ...
              <Link
                href="/leistungen/prozessoptimierung/begriffserklaerung"
                className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-implementers-blue/40 hover:bg-white"
              >
                Begriffserklärung
              </Link>
              <Link
                href="/leistungen/prozessoptimierung/5s"
                className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-implementers-blue/40 hover:bg-white"
              >
                5S Arbeitsplatzorganisation
              </Link>
              <Link
                href="/leistungen/prozessoptimierung/six-sigma"
                className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-implementers-blue/40 hover:bg-white"
              >
                Six Sigma / 6S
              </Link>
              <Link
                href="/leistungen/prozessoptimierung/lean"
                className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-implementers-blue/40 hover:bg-white"
              >
                Lean / Wertschöpfung
              </Link>
              <Link
                href="/leistungen/prozessoptimierung/tps"
                className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-implementers-blue/40 hover:bg-white"
              >
                TPS
              </Link>
